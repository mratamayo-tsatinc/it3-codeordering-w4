const EXERCISES = [
    'Basic Structure.c',
    'Basic Structure and Printing.c',
    'Declaring Constant.c',
    'Escape Characters.c',
    'User Welcome Banner.c',
    'Print Triangle.c',
    'Starry Ascension.c',
    'Rainbow Arch.c',
    'Personal Information Display.c',
    'Personal Information.c',
    'Invoice Generation.c',
    'Book Reservation.c',
    'Using scanf.c',
    'Wage Calculator.c',
    'C to F.c',
    'Circle Area Calculator.c',
    'Cube Volume Finder.c',
    'Name Input.c',
